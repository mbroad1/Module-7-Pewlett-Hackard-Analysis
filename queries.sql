...
-- Joining retirement_info and dept_emp tables, but with aliases
SELECT ri.emp_no,
    ri.first_name,
	ri.last_name,
    de.to_date
...
-- Joining departments and dept_manager tables, but with aliases
SELECT d.dept_name,
     dm.emp_no,
     dm.from_date,
     dm.to_date
...
-- Creates a new table, current_emp
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
	de.to_date
...
-- Creating table with retiring employees salaries and gender
SELECT e.emp_no,
    e.first_name,
	e.last_name,
    e.gender,
